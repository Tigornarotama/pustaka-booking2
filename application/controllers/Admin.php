...
class Admin extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $detail = $this->db->query("SELECT*FROM booking,booking_detail, buku WHERE 
        booking.id_booking=booking_detail.id_booking and booking_detail.id_buku=buku.id")->result_array();
        ...
        if ($beda->days > 2) {
         $this->db->query("UPDATE buku SET stok=stok+1, dibooking=dibooking-1 WHERE 
    id='$id_buku'");
         }
    }
